...
function EmailAutoComplete(options) {
    ...
    this.config = {
        ...
        mailArr: ["@qq.com", "@gmail.com", "@126.com", "@163.com", "@hotmail.com", "@yahoo.com",
            "@yahoo.com.cn", "@sohu.com", "@sina.com"], //邮箱数组
...
EmailAutoComplete.prototype = {
        ...
        if (curIndex > -1) {
            ...
            if (_cache.onlyFlag) {
                ...
                for (var i = 0; i < _config.mailArr.length; i++) {
                    wrap += '<li class="p-index' + i + '">' + '<span class="output-num"></span><em class="em" data-html="'
                        + _config.mailArr[i] + '">' + _config.mailArr[i] + '</em></li>';
                }
                wrap += '</ul>';
        ...
        if (/@/.test(curVal)) {
            ...
            if (newArrs.length > 0) {
                ...
                for (var j = 0, jlen = newArrs.length; j < jlen; j++) {
                    html += '<li class="p-index' + j + '">' + '<span class="output-num"></span><em class="em" data-html = "'
        ...
        if ($('.auto-tip' + ' li', parentNode) && $('.auto-tip' + ' li').length > 0) {
            ...
            if (keyCode == 38) {
                ...
                if (_cache.currentIndex !== -1) {
                    ...
                    !$('.auto-tip .p-index' + _cache.currentIndex, parentNode).hasClass

                    (_config.hoverBg) &&
                    $('.auto-tip .p-index' + _cache.currentIndex, parentNode).addClass(_config.hoverBg).siblings().removeClass

                    (_config.hoverBg);

                    var curAttr = $('.auto-tip' + ' .p-index' + _cache.currentIndex, parentNode).attr
    ...
    _executeClick: function (parentNode) {
        ...
        $('.auto-tip' + ' li', parentNode).bind('click', function (e) {
            ...
            if (_config.isSelectHide) {
                !$(".auto-tip", parentNode).hasClass('hidden') && $(".auto-tip", parentNode).addClass
